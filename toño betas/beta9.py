...
def agregar_producto():
    ...
    # 🔹 Formatear cantidad, precio y subtotal a 2 decimales
...
def generar_factura_pdf():
    ...
    # Registrar fuente personalizada Borel
    pdf.add_font('Borel', '', r'D:\visualcode\toño\Borel\Borel-Regular.ttf', uni=True)
