...
# ========================
# Función para enviar datos por correo al cliente seleccionado
# ========================
...
btn_enviar_correo = tk.Button(frame_btn, text="Enviar Datos por Correo", command=enviar_datos_cliente, bg="orange", fg="white")
